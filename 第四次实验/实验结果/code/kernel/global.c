...
SEMAPHORE nr_readers = {3, 0, "nr_readers"}; //读上限人数信号量，控制读上限人数
...
int schedulable_queue[NR_TASKS - 1] = {0,1,2,3,4}; //减去一个进程是因为A进程特殊判断来调用
